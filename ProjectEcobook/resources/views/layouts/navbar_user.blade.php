            ...
            <div class="row">
                <div class="col-lg-12 col-sm-12 text-center">
                    <div class="main-menu-wrap">
                        ...
                        <nav class="main-menu">
                            <ul>
                                <li class="{{ Request::is('home/user') ? 'current-list-item ' : ''}}"><a href="{{url('/home/user')}}">Home</a></li>
                                <li class="{{ Request::is('home/user/about') ? 'current-list-item ' : ''}}"><a href="{{url('/home/user/about')}}">About</a></li>
                                <li><a href="#">Keranjang Anda</a></li>
                                <li><a href="shop.html">Produk Lainya</a></li>
