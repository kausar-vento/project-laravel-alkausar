                        ...
                        <div class="card-body p-md-5">
                            <div class="row justify-content-center">
                                <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                                    ...
                                    <p class="text-center h1 fw-bold mb-5 mx-1 mx-md-4 mt-4">Register Penjual</p>

                                    <form class="mx-1 mx-md-4" action="{{route('penjual.prosesRegisterPenjual')}}"
                                        method="POST">
                                        @csrf
                                        ...
                                        <div class="d-flex flex-row align-items-center mb-4">
                                            <i class="fas fa-dumpster fa-lg me-3 fa-fw"></i>
                                            <div class="form-outline flex-fill mb-0">
                                                <input type="text" id="form3Example1c" name="nama_toko"
                                                    class="form-control" value="{{old('nama_toko')}}" />
                                                <label class="form-label" for="form3Example1c">Nama Toko</label>
                                            </div>
                                        </div>
                                        ...
                                        <div class="d-flex justify-content-center mx-4 mb-3 mb-lg-4">
                                            ...
                                            <a class="btn btn-success btn-lg" href="{{route('penjual.loginPenjual')}}">Login</a>
                                        </div>
